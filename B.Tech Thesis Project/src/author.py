#Program To Calculate Author's Citations and Publications Over A Specified Period Of Time.
...
"""
with open('authorid_10pubs.txt','w') as fp:
    json.dump(authorid_10pubs,fp,indent=4)

with open('authorid_10years.txt','w') as fp:
